...
when defined(useNodeIds):
  const nodeIdToDebug* = 6364456 # 2322968
...
proc newNodeAux(
  ...
  ## base proc to create new nodes, the exported procs below act as both
  ## interfaces and capture intention for tracing/debugging, while this does
  ## the work.
...
proc newTreeAux(
  ...
  ## base proc to create a new tree, export procs below act as both interfaces
  ## and capture intention for tracing/debugging, while this does the work.
  result = newNodeAux(kind, info, typ, 0)
